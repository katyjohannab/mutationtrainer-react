    ...
    >
      <div
        className={cn(
          ...
          "px-[clamp(1.25rem,5vw,4rem)] py-[clamp(1rem,3.5vw,2rem)]",
          styles.fill,
          styles.text,
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 flex items-center justify-center gap-1.5 sm:gap-2.5 w-full min-w-0">
          {showPin && (
            <div
              className={cn(
          ...
          <span className="text-[clamp(2.25rem,7vw,5rem)] break-words hyphens-auto min-w-0 flex-1 text-center">
            {text}
          </span>
        </div>
      </div>
