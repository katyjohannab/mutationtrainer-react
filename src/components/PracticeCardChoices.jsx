      ...
      <div className="mt-4 grid gap-2 sm:gap-3">
        {choices.map((choice, idx) => (
          <button
            ...
            className={cn(
              "w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-left text-sm sm:text-base shadow-sm transition hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700/30",
